(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".recommendations__swiper")) new core(".recommendations__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".similar__swiper")) new core(".similar__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".viewed__swiper")) new core(".viewed__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                watchOverflow: true,
                navigation: {
                    prevEl: ".viewed__btn-prev",
                    nextEl: ".viewed__btn-next"
                },
                on: {}
            });
        }
        ...
        let dropmenu_isMobile = {
            ...
            any: function() {
                return dropmenu_isMobile.Android() || dropmenu_isMobile.BlackBerry() || dropmenu_isMobile.iOS() || dropmenu_isMobile.Opera() || dropmenu_isMobile.Windows();
            }
        };
        let body = document.querySelector("body");
        if (dropmenu_isMobile.any()) {
